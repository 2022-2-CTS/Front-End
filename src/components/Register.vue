    ...
    <div class="body-regi">
        ...
        <div class="input-pw">
          ...
          <Form style="margin-top:10px">
            ...
            <div class="validate-check" v-if="state.pwEqCheck === true && state.form.Rpw != ''">비밀번호가 일치합니다.</div>
            <div class="validate-check" v-if="state.pwEqCheck === false && state.form.RpwCheck != ''">비밀번호가 일치하지 않습니다.</div>
          </Form>
        </div>
        <div class="input-id">
